<template>
  <div class="hello">
    ...
    <main id="sections" class="fortcontent">
...
export default {
  ...
  data() {
    return {
      ...
      map: require('../assets/img/fortworld.svg'),
      datum: require('../assets/data/fortdata.js').default,
      ills: {
        'fortress-white.svg': require('../assets/img/logos/fortress-white.svg'),
        '01.png': require('../assets/img/fort/01.png'),
        '02.png': require('../assets/img/fort/02.png'),
        '03.png': require('../assets/img/fort/03.png'),
        '04.png': require('../assets/img/fort/04.png'),
        '05.png': require('../assets/img/fort/05.png'),
        '06.png': require('../assets/img/fort/06.png'),
      }
    }
  },
  created: function() {
...
.fortcontent .section {
    background: rgba(12, 101, 105, 0.95);
    color: #f1f1f1;
}
