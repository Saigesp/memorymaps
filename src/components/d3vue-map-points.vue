<template>
    <div id="d3vuemap" style="height: 100%;"></div>
</template>
<script>
...
export default {
    ...
    props: ['lat', 'lng', 'zoom'],
    mounted: function(){
        this.map = new D3MapPoints(d3.select(this.$el), this.points ,{
            lat: this.lat,
            lng: this.lng,
            zoom: this.zoom,
            height: d3.select(this.$el).attr('height'),
        });
